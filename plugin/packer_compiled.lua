...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-spectre', 'lsp-colors.nvim', 'lightspeed.nvim', 'git-blame.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
