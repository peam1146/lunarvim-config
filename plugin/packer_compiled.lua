...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lsp_signature.nvim', 'lsp-colors.nvim', 'lightspeed.nvim', 'git-blame.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'Comment.nvim', 'nvim-spectre'}, { event = "BufRead *" }, _G.packer_plugins)]]
